<template>
  <main>
    <!-- <chart 
      ...
      auto-resize
    /> -->
    <h1><a href="https://gitee.com/warg/bytomMap.git">Bytom will pass the LN torch</a></h1>
    <!-- <p class="desc">Bytom will pass the LN torch</p> -->
    ...
    <footer>
      <a href="https://gitee.com/warg/bytomMap.git">@warg</a>|<a href="https://gitee.com/warg/bytomMap.git">View on Gitee</a>
    </footer>
